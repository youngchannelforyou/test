    ...
    useEffect(() => {
        ...
        const updateAccessCount = async () => {
            try {
                ...
                const response = await axios.post(`server/updateAccessCount?countParameter=everytime`,);
    ...
    const handleSubmit = (e) => {
        ...
        const updateSurveyData = async () => {
            try {
                ...
                const url = `server/submitSurvey?age=${age}&occupation=${occupation}&aiProficiency=${aiProficiency}&domainsOfInterest=${domainsOfInterest}&purchaseIntent=${purchaseIntent}&additionalComments=${additionalComments}&place=everytime`;
